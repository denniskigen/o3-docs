...
- [Tests](https://github.com/openmrs/openmrs-esm-patient-chart/tree/main/packages/esm-patient-tests-app) - provides tabular and chart-based overviews of the test results available for a patient.
...
- [Patient list management](https://github.com/openmrs/openmrs-esm-patient-management/tree/main/packages/esm-patient-list-management-app) - provides a UI to create and manage patient lists.
### Laboratory app
