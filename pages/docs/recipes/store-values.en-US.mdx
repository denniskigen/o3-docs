...
Provided by `@openmrs/esm-framework` is another way to store data in O3. If you are familiar with [React's context](https://react.dev/reference/react/useContext#reference) it works similarly in the same way. All you
