...
A React Hook is provided to hide the asynchronicity of config loading. The moduleName provided to the `openmrsComponentDecorator` in esm-react-utils is used to look up the configuration elsewhere in the application.
