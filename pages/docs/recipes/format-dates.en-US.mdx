...
Here's an example of how to use `formatDate` given a sample date in the omrs format `1684387260000`
...
Here's an example of how to use `formatDatetime` given a sample date in the omrs format `1684387260000`
