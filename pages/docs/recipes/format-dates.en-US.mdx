...
This utility function formats the input `date` time to a `string` using the format `YYYY-MM-DDTHH:mm:ss.SSSZZ`. It is mostly used to format dates before submitting data in payloads.
