...
- [Admin tools](https://github.com/openmrs/openmrs-esm-admin-tools) - provides an interstitial page that links users to various frontend modules that aren't part of the core EMR such as the form builder, the cohort builder, and the legacy admin page.
