...
* *Brand color #1:* (Primary Color) Impacts the following:
  * Global Navigation Bar color <Image
  src="/global-nav-bar-color.png"
  alt="Global Nav Bar Color"
/>
  * Hover color <Image
  src="/hover-color.png"
  alt="Hover Color"
/>
  * Siderail Highlight Circle color <Image
  src="/highlight-siderail-circle-color.png"
  alt="Highlight Siderail Circle Color"
/>
* *Brand color #2:* (Secondary Color) Impacts the following:
  * Unselected App Nav color <Image
  src="/unselected-app-nav-color.png"
  alt="Unselected App Nav Color"
/>

* *Brand color #3:* (Tertiary Color) Impacts the following:
  * Widget Title Underline color <Image
  src="/widget-title-underline-color.png"
  alt="Widget Title Underline Color"
/>
  * Button color (unselected) <Image
  src="/button-color-unselected.png"
  alt="Button Color unselected"
/>

## Video: O3 Branding Tutorial

<iframe width="560" height="315" src="https://www.youtube.com/embed/u5TmUFBrm_s" title="Theming and White Labelling with OpenMRS 3" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
