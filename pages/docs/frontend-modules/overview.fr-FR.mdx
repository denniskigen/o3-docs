...
<Callout emoji="ℹ️" type="info">
  Des changements significatifs dans l'architecture de l'app shell liés à la façon dont les modules du frontend sont
  chargés ont été introduits dans le cadre de la nouvelle version de l'application. chargement des modules frontaux ont
  été introduits dans [Core v5](/docs/changelog). Si vous n'avez pas vous n'avez pas migré vos modules frontaux pour
  tirer parti de ces nouvelles fonctionnalités, suivez le [Guide de migration](/docs/changelog), suivez le [Guide de
