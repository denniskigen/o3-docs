...
- **Your PR title should indicate the type of change it is** - We use PR titles to determine version bumps when [releasing](/docs/frontend-modules/releasing) frontend modules. PR titles should start with something in parentheses, or the word BREAKING. Examples of good PR titles:
  ...
  The versioning bump to indicate is based on the OpenMRS Frontend 3.0 versioning conventions. _Don’t worry if you aren’t sure which one you should use!_ Your reviewer should make sure your PR has an appropriate one.
