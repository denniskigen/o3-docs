...
This guide is for migrating frontend modules to Core v6 and above. The changes in this guide correspond to [this pull request](https://github.com/openmrs/openmrs-esm-core/pull/1346), which was first published as `openmrs@6.3.1-pre.2986`.
...
Following the [v3.4.0 release](https://openmrs.atlassian.net/wiki/spaces/docs/pages/384696321/Release+Notes+3.4+2025-05), we undertook a major tooling upgrade that [culminated in this PR](https://github.com/openmrs/openmrs-esm-core/pull/1346). This represents a fundamental change in how we build, run, and test frontend modules in O3.
...
We recommend using [fnm](https://github.com/Schniz/fnm) to manage multiple Node.js versions on your system:
...
├── mock.tsx        # For ES modules (Vitest, modern Jest)
├── mock-jest.tsx   # For CommonJS (traditional Jest)
...
- **Migrated repositories:** We've migrated several repositories over to Core v6. See the [Migration examples](#migration-examples) section above for the full list.
