...
- **Read and fill out the PR template when filing a PR**
...
- **Your PR title should indicate the type of change it is** - We use PR titles to determine version bumps. PR titles should start with something in parentheses, or the word BREAKING. Examples of good PR titles:
