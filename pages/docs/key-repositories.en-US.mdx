...
- [Laboratory header](https://github.com/openmrs/openmrs-esm-laboratory-app/tree/main/src) - Displays the page header details, including the page name, icon, and other relevant information.
