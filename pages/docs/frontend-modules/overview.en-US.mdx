...
<Callout emoji="ℹ️" type="info">
  Significant changes to the architecture of the app shell related to how frontend modules get loaded were introduced in
  [Core v5](/docs/changelog). If you haven't migrated your frontend modules to leverage these new capabilities, follow
  the [Migration Guide](/docs/migration-guide) for a in-depth walkthrough of how to do so.
</Callout>
