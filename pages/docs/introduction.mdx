...
So, what is O3? O3, alternately referred to as **3.0**, **OpenMRS 3.0**, or **OpenMRS 3.x**, is a new frontend framework for OpenMRS that leverages modern frontend technologies with the goal of being used across as many organizations as possible.
