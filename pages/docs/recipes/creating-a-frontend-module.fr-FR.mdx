...
<Callout emoji="ℹ️" type="info">
  ...
  [polyrepo](https://monorepo.tools/#what-is-a-monorepo). Si vous voulez créer
  un nouveau module frontend dans une monorepo, voir la note sur les monorepos ci-dessous.
</Callout>
