...
- Incase of any need for **Collaborative Solution** regarding a **Coding Blocker** leverage [Tuple](https://production.tuple.app/c/t9We3L) that could be one of the recommended tool for pair programming exclussively for developers ...Its currently available for **_Linux_** and **_Mac_** users and you can find more about it on [Tuple Official website](https://tuple.app/)

### Contributing guidelines

- **Pull requests (PRs) are not required to correspond to a ticket** - If there is a ticket for the PR, it should be clearly named and linked in the PR.
