...
- _Brand color #1:_ (Primary Color) Impacts the following:
  ...
  <Image src="/global-nav-bar-color.png" alt="Global Nav Bar Color" /> - Hover color{" "}

  <Image src="/hover-color.png" alt="Hover Color" />- Siderail Highlight Circle color{" "}
...
- _Brand color #2:_ (Secondary Color) Impacts the following:
  ...
  - Unselected App Nav color
    <Image src="/unselected-app-nav-color.png" alt="Unselected App Nav Color" />
...
- _Brand color #3:_ (Tertiary Color) Impacts the following:
  ...
  - Button color (unselected)
    <Image src="/button-color-unselected.png" alt="Button Color unselected" />
