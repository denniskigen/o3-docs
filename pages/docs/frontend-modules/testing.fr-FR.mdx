...
Voici une vidéo intéressante de Brandon sur le test des modules frontend:

<br />
<iframe width="560" height="315" src="https://www.youtube.com/embed/cGfFufJZV1M?si=vbkxuhecp619GYS7" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
