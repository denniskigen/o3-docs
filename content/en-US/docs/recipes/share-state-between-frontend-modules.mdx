...
managing state using [Zustand](https://docs.pmnd.rs/zustand/getting-started/introduction).
...
export const bookStore = createGlobalStore("books", {
  books: [],
});
```
...
See the [Zustand docs](https://docs.pmnd.rs/zustand/getting-started/introduction) for more
