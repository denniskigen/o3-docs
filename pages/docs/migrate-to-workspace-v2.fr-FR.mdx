...
<Callout type="warning">
  Workspace v2 est actuellement marqué comme **expérimental**. L'API peut changer dans les versions futures. Cependant, plusieurs dépôts majeurs ont déjà migré vers cette version, et l'API workspace v1 est dépréciée.
</Callout>
