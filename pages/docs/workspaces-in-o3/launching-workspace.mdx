...
To launch a patient workspace, requiring a visit, you can utilize the `useLaunchWorkspaceRequiringVisit`.

If the visit is enabled on the system and the patient doesn't have an active visit, the user will be prompted to start a new visit before launching a workspace.
