...
- Lors de la simulation de fonctionnalités de `@openmrs/esm-framework`, suivez les modèles de simulation décrits [ici](/docs/frontend-modules/unit-and-integration-testing#mocking-patterns).
