...
To learn more about the `develop` command, read through its implementation [here](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/tooling/openmrs/src/cli.ts#L93).
